...
import { ITransactionReport, ITransactionReportCashier } from '@/types/report.type';
...
interface ITransactionReportTableProps<TData extends ITransactionReportCashier, TValue> {
...
const globalFilterFn = (row: { original: ITransactionReportCashier }, value: string) => {
  const searchValue = value.toLowerCase();
  const cashierNames = row.original.cashierNames.find((name) => name.toLowerCase().includes(searchValue));

  return cashierNames !== undefined;
};

export function CashierReportsDataTable<TData extends ITransactionReportCashier, TValue>({
  columns,
  data,
