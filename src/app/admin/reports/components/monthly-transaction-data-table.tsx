...
interface ITransactionReportTableProps<TData extends ITransactionReportMonthly, TValue> {
...
export function MonthlyReportsDataTable<TData extends ITransactionReportMonthly, TValue>({
  columns,
  data,
